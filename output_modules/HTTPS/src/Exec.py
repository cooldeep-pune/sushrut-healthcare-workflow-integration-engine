...
def run_connector(
    ...
    dest_url = json_channel['channel']['destinationConnectors']['connector']['properties']['url']
    
    os.system("python3 -u /opt/healthcare-workflow/httpsSender.py -u " + dest_url + " -c " + channel_id)
