...
def run_connector(
    ...
    remoteAddress = json_channel['channel']['destinationConnectors']['connector']['properties']['remoteAddress']
    remotePort = json_channel['channel']['destinationConnectors']['connector']['properties']['remotePort']
    
    os.system("python3 /opt/healthcare-workflow/hl7Sender.py -raddr " + remoteAddress + " -rport "+ remotePort +" -c " + channel_id)
