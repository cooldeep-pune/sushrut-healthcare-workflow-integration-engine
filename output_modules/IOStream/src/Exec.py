...
def run_connector(
    ...
    dest_port = json_channel['channel']['destinationConnectors']['connector']['properties']['remotePort']
    remote_queue = json_channel['channel']['destinationConnectors']['connector']['properties']['remote_queue']
    dest_host = json_channel['channel']['destinationConnectors']['connector']['properties']['remoteAddress']
    
    os.system("python3 /opt/healthcare-workflow/IOStream_writer.py -p " + dest_port + " -c " + channel_id + " -host " + dest_host + " -qname " + remote_queue)
