...
def run_connector(
    ...
    src_ae_title = json_channel['channel']['sourceConnector']['properties']['applicationEntity']
    
    os.system("python3 /opt/healthcare-workflow/healthcare-workflow-DICOMReceiver.py " + src_port +" -aet " + src_ae_title + " -c " + channel_id )
