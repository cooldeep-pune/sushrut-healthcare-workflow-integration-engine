...
def run_connector(
    ...
    host_name = json_channel['channel']['sourceConnector']['properties']['listenerConnectorProperties']['host']
    qname = json_channel['channel']['sourceConnector']['properties']['queue_name']
    os.system("python3 /opt/healthcare-workflow/IOStream_reader.py -p " + src_port + " -c " + channel_id + " -host " + host_name + " -qname " + qname)
